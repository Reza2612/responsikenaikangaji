...
namespace ResponsiPemrog2612
{
    class Program
    {
        static void Main(string[] args)
        {
            Karyawan kr1 = new Karyawan("190302123", "Sadewa", 3000000);
            Karyawan kr2 = new Karyawan("190302124", "Wiku", 2000000);
            ...
            Console.WriteLine("---------------------------------------");
            Console.WriteLine("Asik Kenaikan Gaji 10%");
            Console.WriteLine("No    Nik/Nama             Gaji Bulanan");
